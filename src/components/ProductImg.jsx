...
const ProductImg = () => {
  return (
    <div className="d-flex flex-row justify-content-center align-items-start gap-3 w-100">
      
      {/* 📌 Thumbnail Images & Video */}
      <div className="d-flex flex-column gap-3 justify-content-start align-items-center">
      ...
      <div className="d-flex flex-column gap-3 justify-content-center align-items-start w-100">
        <div className="d-flex flex-column gap-3 justify-content-center align-items-center w-100">
          ...
          {/* 🔥 Best For Section */}
          <div className="d-flex flex-row justify-content-center align-items-center gap-3 border bg-light py-2 rounded-1 w-100">
            Best For:
            {productImages.bestFor.map((item, index) => (
              <span key={index} className="d-flex align-items-center gap-2">
                <i className={`${item.icon} border p-2 bg-white rounded-1`}></i>
